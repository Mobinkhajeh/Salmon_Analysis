...
food <- as.data.frame(read.table("C:/Users/mobin/OneDrive/Documents/Salmon/new_salmon/data_12_28_21/merged_file.txt",check.names=F))

diff_in_health_outcome <- read.table(file="C:/Users/mobin/OneDrive/Documents/Salmon/new_salmon/data_12_28_21/health_outcome.txt",header=T)
complete_health_outcome <- read.table(file="C:/Users/mobin/OneDrive/Documents/Salmon/new_salmon/data_12_28_21/complete_health_outcome.txt",header=T)
...
write.csv(food, "C:/Users/mobin/OneDrive/Documents/Salmon/new_salmon/data_12_28_21/salmon_table/Original_Dataset.csv", row.names=F)
```

Assigning Metabolite Names Such as: "M.1", "M.2", ... to Unique to Salmon Metabolites
```{r}
metabolite_info <- as.data.frame(read.table("C:/Users/mobin/OneDrive/Documents/Salmon/new_salmon/data_12_28_21/met_info.txt",header=T))
...
write.csv(metabolite_info, "C:/Users/mobin/OneDrive/Documents/Salmon/new_salmon/data_12_28_21/salmon_table/Metabolite_Information.csv", row.names=F)
...
write.csv(missing_summary, "C:/Users/mobin/OneDrive/Documents/Salmon/new_salmon/data_12_28_21/salmon_table/Summary_Missing_less_75_Percent.csv", row.names=F)
```
...
for(i in 1:length(Metabolite)){
  ...
  ggsave2(filename=paste0("Metabolite_", Metabolite[i],".jpeg", sep=""), plot=p.out, device="jpeg",
          path=paste0("C:/Users/mobin/OneDrive/Documents/Salmon/new_salmon/data_12_28_21/salmon_plot"))
}

spaghetti

plot_row<-plot_grid(raw_plot, normalized_plot,spaghetti)
p.out<-plot_grid(plot_row, labels=as.character(m), axis="b", label_size=12, vjust=1.5, scale = 0.95)

ggsave2(filename=paste("DIFF_metab_", as.character(m), ".jpeg", sep=""), plot=p.out, device="jpeg", path="/Users/audreyhendricks/Desktop/CU Denver/Research/Active/nutrition/Foodomics/plasma/DIFF_plots_topresults/RECALLED/pval.001")
...
write.csv(cross_section_ranked, "C:/Users/mobin/OneDrive/Documents/Salmon/new_salmon/data_12_28_21/salmon_table/Ranking_metabolites.csv", row.names=F)
```
...
write.csv(difference_ranked_change_analysis,
          "C:/Users/mobin/OneDrive/Documents/Salmon/new_salmon/data_12_28_21/salmon_table/Change_in_Ranks_Metabolites.csv", row.names=F)
```
...
write.csv(change_analysis_change_no_cov,
          "C:/Users/mobin/OneDrive/Documents/Salmon/new_salmon/data_12_28_21/salmon_table/Change_in_Ranks_Primary_Analysis.csv", row.names=F)
...
write.csv(change_analysis_change_cov,
          "C:/Users/mobin/OneDrive/Documents/Salmon/new_salmon/data_12_28_21/salmon_table/Change_in_Ranks_Secondary_Analysis.csv", row.names=F)
```
...
write.csv(method_M_no_cov, "C:/Users/mobin/OneDrive/Documents/Salmon/new_salmon/data_12_28_21/salmon_table/Stratified_Change_in_Ranks_Primary_Males.csv", row.names=F)
```
...
write.csv(method_M_cov, "C:/Users/mobin/OneDrive/Documents/Salmon/new_salmon/data_12_28_21/salmon_table/Stratified_Change_in_Ranks_Secondary_Males.csv", row.names=F)
```
...
write.csv(method_F_no_cov, "C:/Users/mobin/OneDrive/Documents/Salmon/new_salmon/data_12_28_21/salmon_table/Stratified_Change_in_Ranks_Primary_Females.csv", row.names=F)
```
...
write.csv(method_F_cov, "C:/Users/mobin/OneDrive/Documents/Salmon/new_salmon/data_12_28_21/salmon_table/Stratified_Change_in_Ranks_Secondary_Females.csv", row.names=F)
```
