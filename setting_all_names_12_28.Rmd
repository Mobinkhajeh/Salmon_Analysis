...
food <- as.data.frame(fread("C:/Users/mobin/OneDrive/Documents/Salmon/new_salmon/data_12_28_21/Lipid pos unique to Salmon 100% of files - found in plasma_QUANT.txt",sep = "\t", header = T))
...
```{r}
Info_file <- read.csv("C:/Users/mobin/OneDrive/Documents/Salmon/new_salmon/data_12_28_21/S44data_MASTER_41 subjects.csv",as.is = T)
...
```{r}
batch_file <- read.csv("C:/Users/mobin/OneDrive/Documents/Salmon/new_salmon/data_12_28_21/compound_values_raw_height.csv",as.is = T) 
...
### Health Outcome
```{r}
complete_health_outcome <- read.csv("C:/Users/mobin/OneDrive/Documents/Salmon/new_salmon/data_12_28_21/S44data_MASTER_41 subjects.csv")
```
...
write.table(new_merged,
            file="C:/Users/mobin/OneDrive/Documents/Salmon/new_salmon/data_12_28_21/merged_file.txt",row.names=T)
write.table(diff_health,
            file="C:/Users/mobin/OneDrive/Documents/Salmon/new_salmon/data_12_28_21/health_outcome.txt",row.names=T)
write.table(complete_health_outcome,
            file="C:/Users/mobin/OneDrive/Documents/Salmon/new_salmon/data_12_28_21/complete_health_outcome.txt",
            row.names = T)
write.table(met_info,
            file="C:/Users/mobin/OneDrive/Documents/Salmon/new_salmon/data_12_28_21/met_info.txt",
            row.names = T)
```
